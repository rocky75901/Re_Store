...
const Layout = ({
  ...
  const handleSearch = (e) => {
    ...
    const newPathWithSearch = `${location.pathname}${
      newSearch ? `?${newSearch}` : ""
    }`;
        ...
        <div className="Layout-bottom-left">
          <div className="Layout-options">
            ...
            <button
              ...
              style={{
                backgroundColor: isActiveRoute("/messages")
                  ? "#150c7b"
                  : "transparent",
            ...
            <button
              ...
              style={{
                backgroundColor: isActiveRoute("/favorites")
                  ? "#150c7b"
                  : "transparent",
            ...
            <button
              ...
              style={{
                backgroundColor: isActiveRoute("/orders")
                  ? "#150c7b"
                  : "transparent",
            ...
            <button
              ...
              style={{
                backgroundColor: isActiveRoute("/sellpage")
                  ? "#150c7b"
                  : "transparent",
            ...
            <button
              ...
              style={{
                backgroundColor: isActiveRoute("/faq")
                  ? "#150c7b"
                  : "transparent",
            ...
            >
              <i
                className={`fa-solid ${
                  user ? "fa-right-from-bracket" : "fa-sign-in-alt"
                } Layout-icons`}
              ></i>
              {isOpen && (
              ...
              <div className="Layout-nav-links">
                {user ? (
                  <>
                    ...
                    <span onClick={() => navigate("/sellhistory")}>
                      Sell History
                    </span>
