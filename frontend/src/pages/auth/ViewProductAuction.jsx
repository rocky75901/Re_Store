        ...
        <div className="top-half">
          <div className="top-left">
            <div className="product-title">
              <p>Leader Beast 26T Mountain Cycle for Men</p>
              <p>Base Price : 3000</p>
              <p>Current Bid : 3200</p>
            </div>
          ...
          <div className="top-right">
            <div className="action-buttons">
              ...
              <div className="new-buttons">
                <input  type="text"  placeholder="Enter Your Bid"  className="add-to-cart-btn" />
                <button className="buy-now-btn">Place Bid</button>
              </div>
            </div>
          </div>
        </div>
